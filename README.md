...
+-------------------------------------------------------------------+
        ...
        |                                                 |
+-----------------------+                         +-----------------------+
|    auction-client     |     Socket (TCP)        |    auction-server     |
| (JavaFX UI, Controllers| <=====================> | (Business Services,   |
|  Network listeners)   |                         |  DAOs, Data Source)   |
+-----------------------+                         +-----------------------+
### Client
